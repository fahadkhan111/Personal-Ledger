...
const index = () => {
  ...
  const options = ["Send Email", "Delete"];
  ...
  return (
    <div className="py-10">
      <div className="flex justify-between">
        <div className="">
          <h1 className="text-3xl">Customer Lists</h1>
          <p className="text-sm py-2">You have total 17890 Customers in Pharmacy.</p>
        </div>
        <div className="">
          <button
          ...
          {/* here is list */}
      <div className="overflow-x-auto border px-10 py-6 mt-6  rounded-lg">
